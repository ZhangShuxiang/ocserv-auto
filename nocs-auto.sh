...
CatVariable
echo "CatVariable Successful!"

nohup bash ./Variable.sh InstallOcserv &
wait $!
echo "InstallOcserv Successful!"

nohup bash ./Variable.sh InstallCert &
wait $!
echo "InstallCert Successful!"

bash ./Variable.sh InstallUserCert
echo "InstallUserCert Successful!"

nohup bash ./Variable.sh ConfigOcserv &
wait $!
echo "ConfigOcserv Successful!"

nohup bash ./Variable.sh InstallHtml &
wait $!
echo "InstallHtml Successful!"

nohup bash ./Variable.sh ConfigFirewall &
wait $!
echo "ConfigFirewall Successful!"

nohup bash ./Variable.sh ConfigSystem &
wait $!
